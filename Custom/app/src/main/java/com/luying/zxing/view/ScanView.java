...
//	Bitmap bitmap;
	...
	public ScanView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.ScanView);

		//获取自定义属性和默认值
		maskColor = mTypedArray.getColor(R.styleable.ScanView_maskColor, 0xbf000000);
		angleColor = mTypedArray.getColor(R.styleable.ScanView_angleColor, Color.GREEN);
		mSlideIcon = mTypedArray.getDrawable(R.styleable.ScanView_slideIcon);
